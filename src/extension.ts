...
//                 completionItems.map(item => ({
//                     label: item.label.toString(),
//                     detail: item.documentation instanceof vscode.MarkdownString ? item.documentation.value : ''
//                 })),
//                 {
//                     placeHolder: 'Start typing the icon name...',
//                     matchOnDetail: false
...
//                 });
//             });
//             vscode.window.showInformationMessage(`Icon '${iconName.label}' inserted successfully!`);
